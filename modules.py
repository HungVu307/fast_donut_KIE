...
# from donut.model import DonutConfig, DonutModel
from donut.fast_model import DonutConfig, DonutModel
import os
import random
    ...
    def validation_step(self, batch, batch_idx, dataloader_idx=0):
        ...
        for pred, answer in zip(preds, answers):
            ...
            if self.config.get("verbose", False) and len(scores) == 1:
                ...
                self.print(f"\033[1;34mPrediction:\033[0m {pred}")
                self.print(f"\033[1;32m    Answer:\033[0m {answer}")
                self.print(f"\033[1;31m Normed ED:\033[0m {scores[0]}")
