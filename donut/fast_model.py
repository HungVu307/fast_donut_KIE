...
from timm.models.fastvit import FastVit
...
class FastVIT_Encoder(torch.nn.Module):
    def __init__(self, 
                 input_size: List[int], 
        ...
        # self.fast_vit = FastVit(layers = [2, 2, 4, 2],
        ...
        # if not name_or_path:
        # print('built model pretrain from IMAGENET 1K!!!')
        ...
        # else:
        #     print('Loading weights of encoder from path')
        ...
        self.linear_transform = nn.Linear(self.input_size[0]*self.input_size[1]//1024, 1024, bias=False)
    ...
    def forward(self, x):
        ...
        '''
        x = self.fast_vit.forward_features(x)
...
class DonutConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        window_size: int = 10,
        encoder_layer: List[int] = [1, 1, 7, 1], # default: [2,2,14,2]
        decoder_layer: int = 1, # default: 4
...
class DonutModel(PreTrainedModel):
    ...
    def inference(
        ...
        encoder_reparams = reparameterize_model(self.encoder)
        encoder_reparams.eval()
        last_hidden_state = encoder_reparams(image_tensors)
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        """
        Instantiate a donut model from a pre-trained model configuration.

        Args:
            pretrained_model_name_or_path:
                If set to None, the model will not be pretrained.
        """
        if pretrained_model_name_or_path is not None:
            ...
            # If pretrained_model_name_or_path is None, create a new instance of the model without pretraining.
